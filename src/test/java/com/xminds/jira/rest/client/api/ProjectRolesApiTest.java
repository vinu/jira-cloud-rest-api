...
public class ProjectRolesApiTest {
    ...
    public void createProjectRoleTest() throws ApiException {
        CreateUpdateRoleRequestBean body = null;
        ProjectRole response = api.createProjectRole(body);
    ...
    public void fullyUpdateProjectRoleTest() throws ApiException {
        CreateUpdateRoleRequestBean body = null;
        Long id = null;
        ProjectRole response = api.fullyUpdateProjectRole(body, id);
    ...
    public void getProjectRoleTest() throws ApiException {
        ...
        Long id = null;
        ProjectRole response = api.getProjectRole(projectIdOrKey, id);
    ...
    public void getProjectRolesTest() throws ApiException {
        String projectIdOrKey = null;
        Map<String, String> response = api.getProjectRoles(projectIdOrKey);
    ...
    public void partialUpdateProjectRoleTest() throws ApiException {
        CreateUpdateRoleRequestBean body = null;
        Long id = null;
        ProjectRole response = api.partialUpdateProjectRole(body, id);
