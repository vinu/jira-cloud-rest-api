...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class IssueAttachmentsApi {
  ...
  public AttachmentArchiveMetadataReadable expandAttachmentForHumans(String id) throws ApiException {
    ...
    GenericType<AttachmentArchiveMetadataReadable> localVarReturnType = new GenericType<AttachmentArchiveMetadataReadable>() {};
  ...
  public AttachmentArchiveImpl expandAttachmentForMachines(String id) throws ApiException {
    ...
    GenericType<AttachmentArchiveImpl> localVarReturnType = new GenericType<AttachmentArchiveImpl>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
  ...
  public AttachmentSettings getAttachmentMeta() throws ApiException {
    ...
    GenericType<AttachmentSettings> localVarReturnType = new GenericType<AttachmentSettings>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
   * Delete attachment
