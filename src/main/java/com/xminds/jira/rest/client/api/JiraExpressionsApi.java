...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class JiraExpressionsApi {
  ...
  public JiraExpressionsAnalysis analyseExpression(JiraExpressionForAnalysis body, String check) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling analyseExpression");
    }
    ...
    GenericType<JiraExpressionsAnalysis> localVarReturnType = new GenericType<JiraExpressionsAnalysis>() {};
  ...
  public JiraExpressionResult evaluateJiraExpression(JiraExpressionEvalRequestBean body, String expand) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling evaluateJiraExpression");
    }
    // create path and map variables
    ...
    GenericType<JiraExpressionResult> localVarReturnType = new GenericType<JiraExpressionResult>() {};
    return apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
}
