...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class ProjectVersionsApi {
  ...
  public Version createVersion(Version body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createVersion");
    }
  ...
  public Object deleteAndReplaceVersion(DeleteAndReplaceVersionBean body, String id) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling deleteAndReplaceVersion");
    }
  ...
  public List<Version> getProjectVersions(String projectIdOrKey, String expand) throws ApiException {
    ...
    GenericType<List<Version>> localVarReturnType = new GenericType<List<Version>>() {};
  ...
  public PageBeanVersion getProjectVersionsPaginated(String projectIdOrKey, Long startAt, Integer maxResults, String orderBy, String query, String status, String expand) throws ApiException {
    ...
    GenericType<PageBeanVersion> localVarReturnType = new GenericType<PageBeanVersion>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
   * Get version
  ...
  public VersionIssueCounts getVersionRelatedIssues(String id) throws ApiException {
    ...
    GenericType<VersionIssueCounts> localVarReturnType = new GenericType<VersionIssueCounts>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
  ...
  public VersionUnresolvedIssuesCount getVersionUnresolvedIssues(String id) throws ApiException {
    ...
    GenericType<VersionUnresolvedIssuesCount> localVarReturnType = new GenericType<VersionUnresolvedIssuesCount>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
   * Merge versions
  ...
  public Version moveVersion(VersionMoveBean body, String id) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling moveVersion");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
  ...
  public Version updateVersion(Version body, String id) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateVersion");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
