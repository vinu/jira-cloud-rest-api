...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class IssueTypesApi {
  ...
  public IssueTypeDetails createIssueType(IssueTypeCreateBean body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createIssueType");
    }
    ...
    GenericType<IssueTypeDetails> localVarReturnType = new GenericType<IssueTypeDetails>() {};
  ...
  public List<IssueTypeDetails> getAlternativeIssueTypes(String id) throws ApiException {
    ...
    GenericType<List<IssueTypeDetails>> localVarReturnType = new GenericType<List<IssueTypeDetails>>() {};
  ...
  public IssueTypeDetails updateIssueType(IssueTypeUpdateBean body, String id) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateIssueType");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
