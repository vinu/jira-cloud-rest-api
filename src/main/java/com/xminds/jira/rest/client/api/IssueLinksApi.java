...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class IssueLinksApi {
  ...
  public IssueLink getIssueLink(String linkId) throws ApiException {
    ...
    GenericType<IssueLink> localVarReturnType = new GenericType<IssueLink>() {};
  ...
  public Object linkIssues(LinkIssueRequestJsonBean body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling linkIssues");
    }
    // create path and map variables
