...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class ProjectCategoriesApi {
  ...
  public ProjectCategory createProjectCategory(ProjectCategory body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createProjectCategory");
    }
    ...
    GenericType<ProjectCategory> localVarReturnType = new GenericType<ProjectCategory>() {};
  ...
  public List<ProjectCategory> getAllProjectCategories() throws ApiException {
    ...
    GenericType<List<ProjectCategory>> localVarReturnType = new GenericType<List<ProjectCategory>>() {};
  ...
  public UpdatedProjectCategory updateProjectCategory(ProjectCategory body, Long id) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateProjectCategory");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
    ...
    GenericType<UpdatedProjectCategory> localVarReturnType = new GenericType<UpdatedProjectCategory>() {};
