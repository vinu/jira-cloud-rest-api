...
import com.xminds.jira.rest.client.model.PageBeanString;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class LabelsApi {
  ...
  public PageBeanString getAllLabels(Long startAt, Integer maxResults) throws ApiException {
    ...
    GenericType<PageBeanString> localVarReturnType = new GenericType<PageBeanString>() {};
