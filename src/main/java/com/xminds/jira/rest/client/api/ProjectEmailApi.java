...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class ProjectEmailApi {
  ...
  public ProjectEmailAddress getProjectEmail(Long projectId) throws ApiException {
    ...
    GenericType<ProjectEmailAddress> localVarReturnType = new GenericType<ProjectEmailAddress>() {};
  ...
  public Object updateProjectEmail(ProjectEmailAddress body, Long projectId) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateProjectEmail");
    }
    // verify the required parameter 'projectId' is set
    if (projectId == null) {
