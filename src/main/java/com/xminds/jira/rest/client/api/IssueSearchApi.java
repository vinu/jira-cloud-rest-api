...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class IssueSearchApi {
  ...
  public IssuePickerSuggestions getIssuePickerResource(String query, String currentJQL, String currentIssueKey, String currentProjectId, Boolean showSubTasks, Boolean showSubTaskParent) throws ApiException {
    ...
    GenericType<IssuePickerSuggestions> localVarReturnType = new GenericType<IssuePickerSuggestions>() {};
  ...
  public IssueMatches matchIssues(IssuesAndJQLQueries body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling matchIssues");
    }
    // create path and map variables
    ...
    GenericType<IssueMatches> localVarReturnType = new GenericType<IssueMatches>() {};
  ...
  public SearchResults searchForIssuesUsingJql(String jql, Integer startAt, Integer maxResults, String validateQuery, List<String> fields, String expand, List<String> properties, Boolean fieldsByKeys) throws ApiException {
    ...
    GenericType<SearchResults> localVarReturnType = new GenericType<SearchResults>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
  ...
  public SearchResults searchForIssuesUsingJqlPost(SearchRequestBean body) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling searchForIssuesUsingJqlPost");
    }
    // create path and map variables
    String localVarPath = "/rest/api/3/search";
