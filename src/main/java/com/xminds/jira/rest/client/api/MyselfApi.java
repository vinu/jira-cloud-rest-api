...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-03-10T13:09:14.296+05:30[Asia/Kolkata]")public class MyselfApi {
  ...
  public Locale getLocale() throws ApiException {
    ...
    GenericType<Locale> localVarReturnType = new GenericType<Locale>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
  }
  /**
   * Get preference
  ...
  public Object setLocale(Locale body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling setLocale");
    }
    // create path and map variables
    String localVarPath = "/rest/api/3/mypreferences/locale";
